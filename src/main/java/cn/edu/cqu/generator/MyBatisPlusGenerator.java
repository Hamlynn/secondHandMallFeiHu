...
public class MyBatisPlusGenerator {
    ...
    /**
     * 该函数用于生成代码
     * @Test:该注解为 junit单元测试中的注解 作用可以单独运行该函数
     */
    @Test
    public void codeGenerator() {
        ...
        gc.setAuthor("FEIHU");//Mapper,Service类注解中显示创建人信息
        ...
        dsc.setUrl("jdbc:mysql://139.224.9.104:3306/secondhand_mall?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        //5以下com.mysql.jdbc.Driver  5以上com.mysql.cj.jdbc.Driver
        ...
        pc.setParent("cn.edu.cqu");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
        ...
        strategy.setControllerMappingHyphenStyle(true);  //Controller注解名称，不使用驼峰，使用连字符  user_id
